...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const SettingsWidget() : const WelcomePageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => SettingsWidget(
            ...
            gradYear: params.getParam('gradYear', ParamType.int),
        ...
        FFRoute(
          ...
          builder: (context, params) => EditProfileWidget(
            ...
            gr: params.getParam('gr', ParamType.int),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'Suggestions',
          path: '/suggestions',
          builder: (context, params) => const SuggestionsWidget(),
        ),
        FFRoute(
          name: 'compSci',
          path: '/compSci',
          builder: (context, params) => const CompSciWidget(),
        ),
        FFRoute(
          name: 'Medical',
          path: '/medical',
          builder: (context, params) => const MedicalWidget(),
        ),
        FFRoute(
          name: 'Business',
          path: '/business',
          builder: (context, params) => const BusinessWidget(),
        ),
        FFRoute(
          name: 'chat_2_Details',
          path: '/chat2Details',
        ...
        FFRoute(
          name: 'GPTSuggestions',
          path: '/gPTSuggestions',
          builder: (context, params) => const GPTSuggestionsWidget(),
        )
